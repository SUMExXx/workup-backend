...
const { customerRegister, customerVerify, customerLogin, customerVerifyToken, getCategories, getServiceProviders, getCustomerDetails, updateCustomerDetails } = require('../controllers/customerControllers');
