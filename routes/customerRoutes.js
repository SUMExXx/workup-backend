...
const { customerRegister, customerVerify, customerLogin, customerVerifyToken, getCategories, getServiceProviders, getCustomerDetails } = require('../controllers/customerControllers');
